    ...
    <div class="app">
        <div class="header">
            ...
            <div class="header-menu">
                ...
                <a class="menu-link notify" href="#">My work</a>
                <a class="menu-link" href="#">Discover</a>
                <a class="menu-link notify" href="#">Library</a>
            </div>
        ...
        <div class="wrapper">
            ...
            <div class="main-container">
                <div class="main-header">
                    <a class="menu-link-main" href="#">All Sections</a>
                    <div class="header-menu">
                        <a class="main-header-link is-active" href="#">Home</a>
                        <a class="main-header-link" href="/forum">Forum</a>
                    ...
                    <div class="content-wrapper-header">
                        <div class="content-wrapper-context">
                            <h3 class="img-content">
                                <img width="50px" height="50px" style="margin-right: 10px;" src="https://img.icons8.com/external-flatart-icons-lineal-color-flatarticons/64/000000/external-cd-fine-arts-flatart-icons-lineal-color-flatarticons.png" />
                                Album is planned
                            </h3>
                    ...
                    <div class="content-section">
                        ...
                        <ul>
                            <li class="adobe-product">
                                <div class="products">
                                    <img src="https://cdn-icons-png.flaticon.com/512/2111/2111624.png" style="margin-right: 20px;" width="25px" height="25px">
                                    Spotify
                                </div>
                                <span class="status">
